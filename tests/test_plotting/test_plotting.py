...
def test_plot_bandstruc():
    ...
    axs[2].set_title('Fermi Surface colored by spin')
    plot_bandstruc(axs[2], Hsquare, N_samples=5,labels_points_path=labels_points_path, coloring_operator=Hsquare.operator.spinx,cmap='bwr',show_ylabel=False)